...
const artPieces: ArtPiece[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1661246627162-feb0269e0c07?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwYXJ0JTIwZGVzaWduJTIwY3JlYXRpdmV8ZW58MXx8fHwxNzU2OTI1ODUzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1681239063386-fc4a373c927b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwYWludGluZyUyMGFydHdvcmslMjBjYW52YXN8ZW58MXx8fHwxNzU3MDIyMDYxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "Painting",
    date: "December 2024",
    likes: 31,
    comments: 12,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1605007623951-d53263481857?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbGx1c3RyYXRpb24lMjBjcmVhdGl2ZSUyMGFydHxlbnwxfHx8fDE3NTcwMjIwNjR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1699568542323-ff98aca8ea6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGNvbG9yZnVsJTIwYXJ0fGVufDF8fHx8MTc1Njk2MTU1MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "Abstract",
    date: "November 2024",
    likes: 42,
    comments: 16,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1611087966028-bc70bc75d5f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaG90b2dyYXBoeSUyMGFydGlzdGljJTIwY3JlYXRpdmV8ZW58MXx8fHwxNzU3MDIyMDcwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1707578087102-92520fda8f97?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzY3VscHR1cmUlMjBtb2Rlcm4lMjBhcnR8ZW58MXx8fHwxNzU3MDIyMDc0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "Sculpture",
    date: "January 2025",
    likes: 29,
    comments: 9,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHJlZXQlMjBwaG90b2dyYXBoeSUyMHBvcnRyYWl0fGVufDF8fHx8MTc1NzAyMjA3N3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaXhlZCUyMG1lZGlhJTIwY29sbGFnZSUyMGFydHxlbnwxfHx8fDE3NTcwMjIwODB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "Art and/or Photography",
    date: "December 2024",
    likes: 28,
    comments: 7,
...
export default function ArtDesignPage() {
  ...
  const handleView = (piece: ArtPiece) => {
    ...
    setPieces((prev) =>
      prev.map((p) => (p.id === piece.id ? { ...p, views: p.views + 1 } : p))
    );
  };
  ...
  const filteredPieces = pieces.filter((piece) => {
    ...
    const matchesCategory =
      ...
      (selectedCategory === "painting" && piece.category === "Painting") ||
      (selectedCategory === "illustration" &&
        piece.category === "Illustration") ||
      (selectedCategory === "abstract" && piece.category === "Abstract") ||
      (selectedCategory === "photography" &&
        piece.category === "Photography") ||
      (selectedCategory === "sculpture" && piece.category === "Sculpture");
    ...
    <>
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        <div className="text-center mb-12">
          ...
          >
            Discover exceptional visual artwork from our talented community of
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <Heart
                          size={14}
                          className={piece.isLiked ? "fill-current" : ""}
                        />
                      </Button>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    <span className="flex items-center gap-1">
                      <Heart size={14} />
                      {pieces.find((p) => p.id === selectedPiece.id)?.likes}
                    </span>
                    <span className="flex items-center gap-1">
                      <MessageCircle size={14} />
                      {pieces.find((p) => p.id === selectedPiece.id)?.comments}
                    </span>
                    <span className="flex items-center gap-1">
                      <Eye size={14} />
                      {pieces.find((p) => p.id === selectedPiece.id)?.views}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className={`${
                        pieces.find((p) => p.id === selectedPiece.id)?.isLiked
                          ? "text-red-500"
                          : "text-muted-foreground"
                      } hover:text-red-500`}
                    >
                    ...
                    <Button
                      size="sm"
                      variant="ghost"
                      onClick={() => handleShare(selectedPiece)}
                      className="text-muted-foreground hover:text-primary"
                    >
                      <Share2 size={14} />
                    </Button>

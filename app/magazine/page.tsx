      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        {showSuccessMessage && (
          <div className="mb-6 p-4 bg-[#d4af37]/20 border border-[#d4af37]/50 rounded-xl text-center">
            <p
              ...
              style={{ fontFamily: "Inter, sans-serif" }}
            >
              🎉 Thank you for your interest! Opening Starless Sky now...
            </p>
          </div>
        )}
              ...
              <div className="mb-6">
                ...
                <div className="prose prose-invert max-w-none mb-6">
                  <p
                    ...
                    style={{ fontFamily: "Inter, sans-serif" }}
                  >
                    After seeing that many of our submissions carried darker,
                    more emotional themes, we wanted our writers to know they
                    are not alone. That's when we decided to dedicate an entire
                    issue to mental health which was how Starless Sky was born.
                  </p>
                  <p
                    className="text-muted-foreground leading-relaxed"
                    style={{ fontFamily: "Inter, sans-serif" }}
                  >
                    Starless Sky is our first-ever magazine, created to be a
                    safe place for readers to turn to whenever they feel lost,
                    overwhelmed, or alone. Within its pages, you'll find writing
                    that comforts, connects, and reminds you that it's okay to
                    not be okay and that things can get better.
                  </p>
                  <p
                    className="text-muted-foreground leading-relaxed"
                    style={{ fontFamily: "Inter, sans-serif" }}
                  >
                    Led by Julia Philip, founder of Star to Write, and brought
                    to life with the help of our incredible team, Starless Sky
                    is a digital mental health magazine made for you, and for
                    anyone who needs a reminder that they matter.
                  </p>
                </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p
            ...
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            We're working on more magazines covering different themes and
            topics. Stay tuned for upcoming releases that will continue to give
            voice to important conversations.
          </p>
        </div>
      </div>

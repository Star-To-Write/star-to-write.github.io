        ...
        <>
            <div className="max-w-5xl mx-auto px-6 lg:px-12 py-16">
                ...
                <div className="bg-card/40 backdrop-blur-sm border border-border rounded-xl p-8 lg:p-12 mb-12">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p
                                ...
                                style={{ fontFamily: "Inter, sans-serif" }}
                            >
                                Submit your work to be featured on our main
                                platform
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        Share your creative writing, poetry, short stories,
                        essays, research papers, or any other written work with
                        our community. Our team reviews all submissions and
                        publishes exceptional pieces on our website, giving you
                        the platform to reach readers worldwide.
                    </p>
                    ...
                    <div className="bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/30 rounded-xl p-8 lg:p-12 mb-12">
                        ...
                        <div className="bg-primary/20 border border-primary/40 rounded-lg p-6 mb-6">
                            ...
                            >
                                ...
                                for our upcoming mini magazine issue. This is a
                                special opportunity to be featured in a curated
                        ...
                        >
                            ...
                            issue. Selected pieces will be featured in a
                            beautifully designed digital magazine.
                            <strong className="text-primary">
                                {" "}

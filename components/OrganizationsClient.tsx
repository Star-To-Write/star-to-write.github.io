...
export default function OrganizationsClient({
  ...
  useEffect(() => {
    ...
    const organization = organizations.find((org) => org.slug === selectedSlug);
  ...
  return (
    <>
      ...
      >
        Showing{" "}
        {filteredOrganizations.length === 0 ? 0 : `${startIndex}-${endIndex}`}{" "}
              ...
              <div className="flex items-center gap-4 mb-2 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {org.subjects && org.subjects.length > 0 && (
                    ...
                    >
                      <span className="truncate">{org.subjects[0]}</span>
                    </Badge>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {selectedOrganization.subjects &&
                    selectedOrganization.subjects.length > 0 && (
                      <div className="flex gap-2 flex-wrap mt-2">
                        {selectedOrganization.subjects.map((subject) => (
                          <Badge
                            key={subject}
                            variant="outline"
                  ...
                  selectedOrganization.socials.length > 0 && (
                    <div>
                      ...
                      <div className="flex gap-3 flex-wrap">
                        {selectedOrganization.socials.map((social) => {
                          let url = "";
                          let icon = null;
                          const iconProps = {
                            size: 16,
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      {selectedOrganization.location.country}
                    </p>
                  </div>
                  <div>
                    <h3
                    ...
                    >
                      {selectedOrganization.scope == "city"
                        ? "In my city"
                        : selectedOrganization.scope == "country"
                          ? "In my country"
                          : "Worldwide"}
                    </p>
                  </div>

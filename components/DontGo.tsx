    ...
    return (
        <div className="py-16 border-t border-border/50">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    There's so much more to explore in our literary universe.
                    From thought-provoking essays to creative stories, from
                    breaking news to personal reflections - every piece here is
                    written by passionate young voices who believe in the power
                    of words to create change.
                </p>
                ...
                <div className="flex justify-center items-center">
                    <Button
                        ...
                        asChild
                    >
                        <Link href="/submissions">Explore More Stories</Link>
                    </Button>
                </div>
                {/* Subtle tagline */}

      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8">
        <div className="bg-gradient-to-r from-[#d4af37]/20 to-transparent border border-[#d4af37]/30 rounded-lg p-6 text-center backdrop-blur-sm">
          ...
          <p
            ...
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            Discover newly dropped journalistic pieces from our talented
            writers.
            <br />
            Subscribe to get notified about fresh articles, stories, and
            creative works.
          </p>
          ...
          {isSubscribed ? (
            <div className="bg-[#d4af37]/20 border border-[#d4af37]/50 rounded-lg p-4 max-w-md mx-auto">
              <p
                ...
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                ✨ Thank you for subscribing! You'll receive updates about our
                latest publications.
              </p>
            </div>
          ) : (
